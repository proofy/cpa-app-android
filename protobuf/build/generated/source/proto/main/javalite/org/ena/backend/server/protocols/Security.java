...
public final class Security {
    ...
    public interface SignedPayloadOrBuilder extends
            // @@protoc_insertion_point(interface_extends:de.sj4.coronapartyapp.server.protocols.SignedPayload)
    ...
    /**
     * Protobuf type {@code de.sj4.coronapartyapp.server.protocols.SignedPayload}
     */
    public static final class SignedPayload extends
            com.google.protobuf.GeneratedMessageLite<
                    SignedPayload, SignedPayload.Builder> implements
            // @@protoc_insertion_point(message_implements:de.sj4.coronapartyapp.server.protocols.SignedPayload)
            SignedPayloadOrBuilder {
        public static final int PAYLOAD_FIELD_NUMBER = 1;
        public static final int CERTIFICATECHAIN_FIELD_NUMBER = 2;
        public static final int SIGNATURE_FIELD_NUMBER = 3;
        // @@protoc_insertion_point(class_scope:de.sj4.coronapartyapp.server.protocols.SignedPayload)
        private static final de.sj4.coronapartyapp.server.protocols.Security.SignedPayload DEFAULT_INSTANCE;
        ...
        public static de.sj4.coronapartyapp.server.protocols.Security.SignedPayload parseFrom(
        ...
        public static de.sj4.coronapartyapp.server.protocols.Security.SignedPayload parseFrom(byte[] data)
                throws com.google.protobuf.InvalidProtocolBufferException {
            return com.google.protobuf.GeneratedMessageLite.parseFrom(
                    DEFAULT_INSTANCE, data);
        }
        ...
        public static de.sj4.coronapartyapp.server.protocols.Security.SignedPayload parseFrom(java.io.InputStream input)
        ...
        public static de.sj4.coronapartyapp.server.protocols.Security.SignedPayload parseDelimitedFrom(java.io.InputStream input)
                throws java.io.IOException {
            return parseDelimitedFrom(DEFAULT_INSTANCE, input);
        }

        public static de.sj4.coronapartyapp.server.protocols.Security.SignedPayload parseDelimitedFrom(
                java.io.InputStream input,
                com.google.protobuf.ExtensionRegistryLite extensionRegistry)
                throws java.io.IOException {
        ...
        public static Builder newBuilder(de.sj4.coronapartyapp.server.protocols.Security.SignedPayload prototype) {
            return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
        }

        public static de.sj4.coronapartyapp.server.protocols.Security.SignedPayload getDefaultInstance() {
        ...
        protected final Object dynamicMethod(
            ...
            switch (method) {
                case NEW_MUTABLE_INSTANCE: {
                    return new de.sj4.coronapartyapp.server.protocols.Security.SignedPayload();
                }
                case IS_INITIALIZED: {
                    return DEFAULT_INSTANCE;
                }
                ...
                case VISIT: {
                    ...
                    de.sj4.coronapartyapp.server.protocols.Security.SignedPayload other = (de.sj4.coronapartyapp.server.protocols.Security.SignedPayload) arg1;
                ...
                case GET_PARSER: {
                    if (PARSER == null) {
                        synchronized (de.sj4.coronapartyapp.server.protocols.Security.SignedPayload.class) {
                            if (PARSER == null) {
        ...
        public static final class Builder extends
                com.google.protobuf.GeneratedMessageLite.Builder<
                        de.sj4.coronapartyapp.server.protocols.Security.SignedPayload, Builder> implements
                // @@protoc_insertion_point(builder_implements:de.sj4.coronapartyapp.server.protocols.SignedPayload)
                de.sj4.coronapartyapp.server.protocols.Security.SignedPayloadOrBuilder {
            // Construct using de.sj4.coronapartyapp.server.protocols.Security.SignedPayload.newBuilder()
            private Builder() {
            ...
            // @@protoc_insertion_point(builder_scope:de.sj4.coronapartyapp.server.protocols.SignedPayload)
        }
    }
