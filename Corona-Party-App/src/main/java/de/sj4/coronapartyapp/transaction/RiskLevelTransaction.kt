...
import de.sj4.coronapartyapp.exception.RiskLevelCalculationException
...
import de.sj4.coronapartyapp.risk.RiskLevel.INCREASED_RISK
import de.sj4.coronapartyapp.risk.RiskLevel.LOW_LEVEL_RISK
import de.sj4.coronapartyapp.risk.RiskLevel.NO_CALCULATION_POSSIBLE_TRACING_OFF
import de.sj4.coronapartyapp.risk.RiskLevel.UNDETERMINED
import de.sj4.coronapartyapp.risk.RiskLevel.UNKNOWN_RISK_INITIAL
import de.sj4.coronapartyapp.risk.RiskLevel.UNKNOWN_RISK_OUTDATED_RESULTS
import de.sj4.coronapartyapp.risk.RiskLevelCalculation
import de.sj4.coronapartyapp.risk.TimeVariables
import de.sj4.coronapartyapp.server.protocols.ApplicationConfigurationOuterClass
import de.sj4.coronapartyapp.service.applicationconfiguration.ApplicationConfigurationService
...
import de.sj4.coronapartyapp.transaction.RiskLevelTransaction.RiskLevelTransactionState.CHECK_APP_CONNECTIVITY
import de.sj4.coronapartyapp.transaction.RiskLevelTransaction.RiskLevelTransactionState.CHECK_INCREASED_RISK
import de.sj4.coronapartyapp.transaction.RiskLevelTransaction.RiskLevelTransactionState.CHECK_TRACING
import de.sj4.coronapartyapp.transaction.RiskLevelTransaction.RiskLevelTransactionState.CHECK_UNKNOWN_RISK_INITIAL_NO_KEYS
import de.sj4.coronapartyapp.transaction.RiskLevelTransaction.RiskLevelTransactionState.CHECK_UNKNOWN_RISK_INITIAL_TRACING_DURATION
import de.sj4.coronapartyapp.transaction.RiskLevelTransaction.RiskLevelTransactionState.CHECK_UNKNOWN_RISK_OUTDATED
import de.sj4.coronapartyapp.transaction.RiskLevelTransaction.RiskLevelTransactionState.CLOSE
import de.sj4.coronapartyapp.transaction.RiskLevelTransaction.RiskLevelTransactionState.RETRIEVE_APPLICATION_CONFIG
import de.sj4.coronapartyapp.transaction.RiskLevelTransaction.RiskLevelTransactionState.RETRIEVE_EXPOSURE_SUMMARY
import de.sj4.coronapartyapp.transaction.RiskLevelTransaction.RiskLevelTransactionState.RISK_CALCULATION_DATE_UPDATE
import de.sj4.coronapartyapp.transaction.RiskLevelTransaction.RiskLevelTransactionState.UPDATE_RISK_LEVEL
import de.sj4.coronapartyapp.util.ConnectivityHelper
import de.sj4.coronapartyapp.util.TimeAndDateExtensions.millisecondsToHours
 ...
 * the value will be persisted. Please have a look at the [de.sj4.coronapartyapp.risk.RiskLevel] enum class
 * to see all available technical risk level. At the start of the Transaction the risk level is defined
 * as [de.sj4.coronapartyapp.risk.RiskLevel.UNDETERMINED]. The different execution states will define the correct
 ...
 * than [de.sj4.coronapartyapp.risk.TimeVariables.MAX_STALE_EXPOSURE_RISK_RANGE] time ago and new diagnosis keys are
 ...
 * tracing activation started less than [de.sj4.coronapartyapp.risk.TimeVariables.MIN_ACTIVATED_TRACING_TIME] ago.
 *
 ...
 * @see Transaction
 *
 * @throws de.sj4.coronapartyapp.exception.TransactionException An Exception thrown when an error occurs during Transaction Execution
 * @throws de.sj4.coronapartyapp.exception.RollbackException An Exception thrown when an error occurs during Rollback of the Transaction
 */
object RiskLevelTransaction : Transaction() {
     ...
     * The ExposureSummary will be updated in the [de.sj4.coronapartyapp.receiver.ExposureStateUpdateReceiver]
     ...
     * Google API token that was used in the [de.sj4.coronapartyapp.transaction.RetrieveDiagnosisKeysTransaction]
     *
