...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported by contacting [corona-party-app.opensource@sap.com](mailto:corona-party-app.opensource@sap.com) and/or a project maintainer. 
...
* If you plan to do something more involved, please reach out to us and send an [email](mailto:corona-party-app.opensource@sap.com). This will avoid unnecessary work and surely give you and us a good deal of inspiration.
...
* If your patch is not getting reviewed or you need a specific person to review it, you can @-reply a reviewer asking for a review in the pull request or a comment, or you can ask for a review by contacting us via [email](mailto:corona-party-app.opensource@sap.com).
...
* Please apply one or more applicable [labels](https://github.com/corona-party-app/cwa-app-android/labels) to your issue so that all community members are able to cluster the issues better.